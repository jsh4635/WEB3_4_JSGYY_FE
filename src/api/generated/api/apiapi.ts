...
// @ts-ignore
import type { AccountDTO, UPDATE_POST_DTO } from "../models";
// @ts-ignore
...
// @ts-ignore
import type { OneData } from "../models";
// @ts-ignore
import type { PaymentDTO } from "../models";
// @ts-ignore
import type { UpdateImagesRequest } from "../models";
// @ts-ignore
...
export const APIApiAxiosParamCreator = function (
  ...
  return {
    ...
    bidPrice: async (
      ...
      const localVarPath = `/api/auction/{postId}/bid`.replace(
        `{${"postId"}}`,
    ...
    deleteAlarm: async (
      ...
      const localVarPath = `/api/alarms/{id}`.replace(
        `{${"id"}}`,
    ...
    deleteCategory: async (
      ...
      const localVarPath = `/api/admin/categories/{categoryId}`.replace(
        `{${"categoryId"}}`,
    ...
    deleteChatroom: async (
      ...
      const localVarPath = `/api/chat/rooms/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deletePost: async (
      ...
      const localVarPath = `/api/posts/{postId}`.replace(
        `{${"postId"}}`,
        encodeURIComponent(String(postId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    enterRoom: async (
      roomId: number,
      messageSearchDTO: MessageSearchDTO,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/chat/rooms/{roomId}`.replace(
        `{${"roomId"}}`,
    ...
    getAccount: async (
      ...
      const localVarPath = `/api/account/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getExchangeAccount: async (
      id: number,
      type: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("getExchangeAccount", "id", id);
      // verify required parameter 'type' is not null or undefined
      assertParamExists("getExchangeAccount", "type", type);
      const localVarPath = `/api/account/{id}/exchange`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    likePost: async (
      ...
      const localVarPath = `/api/posts/{postId}/like`.replace(
        `{${"postId"}}`,
        encodeURIComponent(String(postId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @param {OneData} oneData 수정할 항목의 내용을 작성해주세요 nickname &#x3D;&gt; 수정할 닉네임 ex) \&quot;data\&quot; : \&quot;newNickname\&quot; phoneNum &#x3D;&gt; 수정할 전화번호 ex) \&quot;data\&quot; : \&quot;newPhoneNum\&quot; address &#x3D;&gt; 수정할 주소 ex) \&quot;data\&quot; : \&quot;newAddress\&quot;
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    modifyMyDetails: async (
      category: string,
      oneData: OneData,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      ...
      // verify required parameter 'oneData' is not null or undefined
      assertParamExists("modifyMyDetails", "oneData", oneData);
      const localVarPath = `/api/member/modify/{category}`.replace(
        `{${"category"}}`,
    ...
    reportPost: async (
      ...
      const localVarPath = `/api/posts/{postId}/reports`.replace(
        `{${"postId"}}`,
        encodeURIComponent(String(postId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    unlikePost: async (
      ...
      const localVarPath = `/api/posts/{postId}/unlike`.replace(
        `{${"postId"}}`,
        encodeURIComponent(String(postId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    /**
     * 업로드할 사진은 images에 담아 보내고, 삭제할 사진의 id는 deleteImageIds에 담아 보냅니다.
     * @summary 게시글 사진 업로드 & 삭제
     * @param {number} postId
     * @param {UpdateImagesRequest} [updateImagesRequest]
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    updateImages: async (
      postId: number,
      updateImagesRequest?: UpdateImagesRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'postId' is not null or undefined
      assertParamExists("updateImages", "postId", postId);
      const localVarPath = `/api/posts/{postId}/images`.replace(
        `{${"postId"}}`,
        encodeURIComponent(String(postId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     *
     * @summary 회원 탈퇴
     * @param {OneData} oneData 탈퇴를 위한 비밀번호를 작성해주세요 ex) \&quot;data\&quot; : \&quot;12345\&quot;
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    withdrawal: async (
      ...
      // verify required parameter 'oneData' is not null or undefined
      assertParamExists("withdrawal", "oneData", oneData);
...
export const APIApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.bidPrice(
        postId,
        bidDTO,
        options,
      );
      ...
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.bidPrice"]?.[localVarOperationServerIndex]
          ?.url;
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.blockMember"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async confirmExchange(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.confirmExchange(
        paymentDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.confirmExchange"]?.[
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.createAccount"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createAlarm(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.createAlarm"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.createCategory"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async createChatroom(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreateResponseDto>
    > {
    ...
    async createFollow(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<FollowResponseDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createFollow(
        followRequestDto,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.createFollow"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.createPost"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async deleteAlarm(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteAlarm(
        id,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.deleteAlarm"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.deleteCategory"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async deleteChatroom(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteChatroom(
        id,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.deleteChatroom"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.deletePost"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async depositAccount(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.depositAccount(
        depositDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.depositAccount"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async enterRoom(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.enterRoom(
        roomId,
        messageSearchDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.enterRoom"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async findMemberByNickname(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<MemberDTO>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.findMemberByNickname(nickname, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.findMemberByNickname"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getAccount"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async getAlarms(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<AlarmDTO>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getAlarms(
        page,
        size,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getAlarms"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getCategories"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getChatRooms(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ChatRoomListResponseDto>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getChatRooms(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getChatRooms"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getExchangeAccount(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExchangeDTO>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExchangeAccount(id, type, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getExchangeAccount"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getFollows(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getFollows(
        page,
        size,
        sort,
        options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getFollows"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMembers(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getMembers"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async getMyLikes(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyLikes(
        page,
        size,
        sort,
        options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getMyLikes"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async getMyPosts(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyPosts(
        page,
        size,
        sort,
        options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getMyPosts"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getPost"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async getPosts(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DTO>>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.getPosts"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.likePost"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async modifyMyDetails(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.modifyMyDetails(
        category,
        oneData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.modifyMyDetails"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async modifyPost(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.modifyPost(
        postId,
        dTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.modifyPost"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.myDetails(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.myDetails"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async paymentsGood(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.paymentsGood(
        paymentDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.paymentsGood"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.register"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.reissue"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async reportPost(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.reportPost(
        postId,
        dTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.reportPost"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.unFollow"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async unlikePost(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.unlikePost(
        postId,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.unlikePost"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.updateCategory"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async updateImages(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateImages(
        postId,
        updateImagesRequest,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.updateImages"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async withdrawAccount(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.withdrawAccount(
        withdrawDTO,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.withdrawAccount"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async withdrawal(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.withdrawal(
        oneData,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["APIApi.withdrawal"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const APIApiFactory = function (
  ...
  return {
     ...
     */
    bidPrice(
      requestParameters: APIApiBidPriceRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .bidPrice(requestParameters.postId, requestParameters.bidDTO, options)
     ...
     */
    blockMember(
      requestParameters: APIApiBlockMemberRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<object> {
      return localVarFp
        .blockMember(requestParameters.blockMemberDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    confirmExchange(
      requestParameters: APIApiConfirmExchangeRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .confirmExchange(requestParameters.paymentDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    createAccount(
      requestParameters: APIApiCreateAccountRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
     ...
     */
    createCategory(
      requestParameters: APIApiCreateCategoryRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<object> {
      return localVarFp
        .createCategory(requestParameters.categoryDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    createChatroom(
      requestParameters: APIApiCreateChatroomRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CreateResponseDto> {
      return localVarFp
        .createChatroom(requestParameters.chatRoomRequestDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    createFollow(
      requestParameters: APIApiCreateFollowRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<FollowResponseDto> {
      return localVarFp
        .createFollow(requestParameters.followRequestDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    createPost(
      requestParameters: APIApiCreatePostRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .createPost(requestParameters.dTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    deleteAlarm(
      requestParameters: APIApiDeleteAlarmRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .deleteAlarm(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    deleteCategory(
      requestParameters: APIApiDeleteCategoryRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<object> {
      return localVarFp
        .deleteCategory(requestParameters.categoryId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    deleteChatroom(
      requestParameters: APIApiDeleteChatroomRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .deleteChatroom(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    deletePost(
      requestParameters: APIApiDeletePostRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .deletePost(requestParameters.postId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    depositAccount(
      requestParameters: APIApiDepositAccountRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .depositAccount(requestParameters.depositDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    enterRoom(
      requestParameters: APIApiEnterRoomRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .enterRoom(
          requestParameters.roomId,
          requestParameters.messageSearchDTO,
          options,
        )
        .then((request) => request(axios, basePath));
    },
    ...
    findMemberByNickname(
      requestParameters: APIApiFindMemberByNicknameRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<MemberDTO> {
      return localVarFp
        .findMemberByNickname(requestParameters.nickname, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    getAccount(
      requestParameters: APIApiGetAccountRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
     ...
     */
    getAlarms(
      requestParameters: APIApiGetAlarmsRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<AlarmDTO> {
      return localVarFp
        .getAlarms(requestParameters.page, requestParameters.size, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    getExchangeAccount(
      requestParameters: APIApiGetExchangeAccountRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ExchangeDTO> {
      return localVarFp
        .getExchangeAccount(
     ...
     */
    getFollows(
      requestParameters: APIApiGetFollowsRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .getFollows(
     ...
     */
    getMyLikes(
      requestParameters: APIApiGetMyLikesRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .getMyLikes(
     ...
     */
    getMyPosts(
      requestParameters: APIApiGetMyPostsRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .getMyPosts(
     ...
     */
    getPost(
      requestParameters: APIApiGetPostRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .getPost(requestParameters.postId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    getPosts(
      requestParameters: APIApiGetPostsRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<Array<DTO>> {
      return localVarFp
        .getPosts(
          requestParameters.page,
          requestParameters.size,
     ...
     */
    likePost(
      requestParameters: APIApiLikePostRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .likePost(requestParameters.postId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 로그인 후 response에 출력되는 access를 authorize에 입력
     ...
     */
    login(
      requestParameters: APIApiLoginRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<object> {
      return localVarFp
     ...
     */
    modifyMyDetails(
      requestParameters: APIApiModifyMyDetailsRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .modifyMyDetails(
          requestParameters.category,
          requestParameters.oneData,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    modifyPost(
      requestParameters: APIApiModifyPostRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .modifyPost(requestParameters.postId, requestParameters.dTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    paymentsGood(
      requestParameters: APIApiPaymentsGoodRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .paymentsGood(requestParameters.paymentDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 가입할 회원 정보를 RequestBody에 작성하고 실행하세요
     ...
     */
    register(
      requestParameters: APIApiRegisterRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .register(requestParameters.memberDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    reportPost(
      requestParameters: APIApiReportPostRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .reportPost(requestParameters.postId, requestParameters.dTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    unFollow(
      requestParameters: APIApiUnFollowRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<FollowResponseDto> {
      return localVarFp
        .unFollow(requestParameters.followRequestDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    unlikePost(
      requestParameters: APIApiUnlikePostRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .unlikePost(requestParameters.postId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     */
    updateCategory(
      requestParameters: APIApiUpdateCategoryRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<object> {
      return localVarFp
        .updateCategory(
          requestParameters.categoryId,
          requestParameters.categoryDTO,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    updateImages(
      requestParameters: APIApiUpdateImagesRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<object> {
      return localVarFp
        .updateImages(
          requestParameters.postId,
          requestParameters.updateImagesRequest,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    withdrawAccount(
      requestParameters: APIApiWithdrawAccountRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .withdrawAccount(requestParameters.withdrawDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     * @summary 회원 탈퇴
     * @param {APIApiWithdrawalRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    withdrawal(
      requestParameters: APIApiWithdrawalRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .withdrawal(requestParameters.oneData, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export interface APIApiUpdateImagesRequest {
  ...
  /**
   *
   * @type {UpdateImagesRequest}
   * @memberof APIApiUpdateImages
   */
  readonly updateImagesRequest?: UpdateImagesRequest;
}
...
/**
 * Request parameters for withdrawal operation in APIApi.
 * @export
 * @interface APIApiWithdrawalRequest
 */
export interface APIApiWithdrawalRequest {
  /**
   * 탈퇴를 위한 비밀번호를 작성해주세요 ex) \&quot;data\&quot; : \&quot;12345\&quot;
   * @type {OneData}
   * @memberof APIApiWithdrawal
   */
  readonly oneData: OneData;
}
...
export class APIApi extends BaseAPI implements APIApiInterface {
   ...
   * @memberof APIApi
   */
  public getExchangeAccount(
    requestParameters: APIApiGetExchangeAccountRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return APIApiFp(this.configuration)
      .getExchangeAccount(requestParameters.id, requestParameters.type, options)
      .then((request) => request(this.axios, this.basePath));
  }
