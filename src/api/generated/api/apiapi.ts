...
export const APIApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getExchangeAccount: async (id: number, type: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getExchangeAccount', 'id', id)
            // verify required parameter 'type' is not null or undefined
            assertParamExists('getExchangeAccount', 'type', type)
            const localVarPath = `/api/account/{id}/exchange`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        modifyMyDetails: async (category: string, oneData: OneData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(oneData, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        updateImages: async (postId: number, updateImagesRequest?: UpdateImagesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'postId' is not null or undefined
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(updateImagesRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        withdrawal: async (oneData: OneData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'oneData' is not null or undefined
...
export const APIApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAccount(id: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getExchangeAccount(id: number, type: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExchangeDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getExchangeAccount(id, type, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async modifyMyDetails(category: string, oneData: OneData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.modifyMyDetails(category, oneData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateImages(postId: number, updateImagesRequest?: UpdateImagesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateImages(postId, updateImagesRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async withdrawal(oneData: OneData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.withdrawal(oneData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const APIApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getExchangeAccount(requestParameters: APIApiGetExchangeAccountRequest, options?: RawAxiosRequestConfig): AxiosPromise<ExchangeDTO> {
            return localVarFp.getExchangeAccount(requestParameters.id, requestParameters.type, options).then((request) => request(axios, basePath));
        },
        /**
         * sort의 값을 \"id\"로 변경하고 진행
         * @summary 팔로잉 목록 조회
        ...
        modifyMyDetails(requestParameters: APIApiModifyMyDetailsRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.modifyMyDetails(requestParameters.category, requestParameters.oneData, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 게시글 수정
         ...
         * @throws {RequiredError}
         */
        updateImages(requestParameters: APIApiUpdateImagesRequest, options?: RawAxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.updateImages(requestParameters.postId, requestParameters.updateImagesRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 출금 요청 기능
         ...
         * @throws {RequiredError}
         */
        withdrawal(requestParameters: APIApiWithdrawalRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.withdrawal(requestParameters.oneData, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class APIApi extends BaseAPI implements APIApiInterface {
    ...
    public getAccount(requestParameters: APIApiGetAccountRequest, options?: RawAxiosRequestConfig) {
        return APIApiFp(this.configuration).getAccount(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getExchangeAccount(requestParameters: APIApiGetExchangeAccountRequest, options?: RawAxiosRequestConfig) {
        return APIApiFp(this.configuration).getExchangeAccount(requestParameters.id, requestParameters.type, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public modifyMyDetails(requestParameters: APIApiModifyMyDetailsRequest, options?: RawAxiosRequestConfig) {
        return APIApiFp(this.configuration).modifyMyDetails(requestParameters.category, requestParameters.oneData, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateImages(requestParameters: APIApiUpdateImagesRequest, options?: RawAxiosRequestConfig) {
        return APIApiFp(this.configuration).updateImages(requestParameters.postId, requestParameters.updateImagesRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof APIApi
     */
    public withdrawal(requestParameters: APIApiWithdrawalRequest, options?: RawAxiosRequestConfig) {
        return APIApiFp(this.configuration).withdrawal(requestParameters.oneData, options).then((request) => request(this.axios, this.basePath));
    }
}
